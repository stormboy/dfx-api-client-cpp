...
#pragma once
#ifndef DFX_API_CLOUD_STUDY_WEBSOCKET_JSON_H
#define DFX_API_CLOUD_STUDY_WEBSOCKET_JSON_H
...
class StudyWebSocketJson : public StudyAPI
{
public:
    StudyWebSocketJson(const CloudConfig& config, std::shared_ptr<CloudWebSocketJson> cloudWebSocketJson);

    ~StudyWebSocketJson() override = default;
...
#endif // DFX_API_CLOUD_STUDY_WEBSOCKET_JSON_H
