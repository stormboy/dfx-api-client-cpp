...
#pragma once
#ifndef DFX_API_CLOUD_ORGANIZATION_WEBSOCKET_JSON_H
#define DFX_API_CLOUD_ORGANIZATION_WEBSOCKET_JSON_H
...
class OrganizationWebSocketJson : public OrganizationAPI
{
public:
    OrganizationWebSocketJson(const CloudConfig& config, std::shared_ptr<CloudWebSocketJson> cloudWebSocketJson);

    ~OrganizationWebSocketJson() override = default;
...
#endif // DFX_API_CLOUD_ORGANIZATION_WEBSOCKET_JSON_H
