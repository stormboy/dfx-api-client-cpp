...
class dfxprotosweb(ConanFile):
    name = "dfxprotosweb"
    description = "DeepAffex public REST / WebSocket protobufs"
    license = "NuraLogix License"

    def export_sources(self):
        copy(self, "*", src=os.path.join(self.recipe_folder, "include"), dst=os.path.join(self.export_sources_folder, "include"), keep_path=True)
