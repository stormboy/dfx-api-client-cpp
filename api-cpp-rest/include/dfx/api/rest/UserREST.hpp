...
#pragma once
#ifndef DFX_API_CLOUD_USER_REST_H
#define DFX_API_CLOUD_USER_REST_H
...
class UserREST : public UserAPI
{
public:
    UserREST(const CloudConfig& config, const std::shared_ptr<CloudREST>& cloudREST);

    ~UserREST() override = default;
...
#endif // DFX_API_CLOUD_USER_REST_H
